...
impl<T: Read + Seek> PacketIn<T> for PlayPlayerAbilitiesPacket {
...
impl<T: Write + Seek> PacketOut<T> for PlayPlayerAbilitiesPacket {
...
impl PacketRecv for PlayPlayerAbilitiesPacket {}
impl PacketSend for PlayPlayerAbilitiesPacket {}
