...
impl<T: Read + Seek> PacketIn<T> for LoginPacket {
...
impl<T: Write + Seek> PacketOut<T> for LoginPacket {
...
impl PacketRecv for LoginPacket {}
impl PacketSend for LoginPacket {}
