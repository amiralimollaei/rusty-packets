...
impl<T: Read + Seek> PacketIn<T> for FeatureFlagsPacket {
...
impl<T: Write + Seek> PacketOut<T> for FeatureFlagsPacket {
    fn write(&self, writer: &mut PacketWriter<T>) {
        ...
        writer.write_raw_consume(types::Array::new(feature_flags_raw));
    }
}

impl PacketRecv for FeatureFlagsPacket {}
impl PacketSend for FeatureFlagsPacket {}
